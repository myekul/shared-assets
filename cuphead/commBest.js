...
const commBestILs = {
    '1.1+': {
        ...
        top: [
            [35, 47, 24, 63, 36, 33, 49, 77, 43, 51, 43, 45, 48, 41, 42, 58, 64, 111, 45],
            [35, 44, 25, 67, 39, 35, 52, 78, 44, 50, 40, 43, 48, 40, 41, 56, 59, 109, 54]
        ]
    },
    Legacy: {
        name: 'Legacy',
    ...
    NMG: {
        ...
        shot2: 'spread',
        top: [
            [37, 50, 29, 63, 39, 42, 53, 83, 63, 53, 41, 45, 50, 47, 43, 62, 59, 117, 57],
            [38, 48, 30, 64, 36, 36, 55, 83, 62, 50, 41, 48, 50, 50, 44, 62, 61, 117, 56],
            [38, 50, 32, 65, 37, 38, 56, 82, 62, 52, 41, 46, 52, 48, 41, 61, 61, 116, 61],
            [37, 48, 31, 65, 37, 39, 56, 86, 60, 53, 41, 49, 51, 47, 46, 61, 63, 117, 58],
            [],
            [37, 50, 31, 63, 39, 37, 56, 86, 60, 51, 42, 50, 52, 45, 44, 63, 65, 117, 58]
        ]
    },
    'NMG P/S': {
        name: 'NMG',
